...
from NewRelaxation import NewRelaxationTissueModel
...
sphere_relax = NewRelaxationTissueModel(sphere, T2 = 0.020)
...
stick_relax = NewRelaxationTissueModel(stick, T2 = 0.020)
